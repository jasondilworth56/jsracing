...
export const mSite = 'https://members.iracing.com/membersite/member'
export const mStats = 'https://members.iracing.com/memberstats/member'

// IRACING SERVICE URLS
export const URL_LOGIN = 'https://members.iracing.com/membersite/login.jsp'
export const URL_LOGIN2 = 'https://members.iracing.com/membersite/Login'
export const URL_LOGOUT = 'https://members.iracing.com/membersite/LogOut'
export const URL_HOME = 'https://members.iracing.com/membersite/member/Home.do'

// THE BIG ONES
export const URL_DRIVER_STATS = (mStats + '/GetDriverStats')
export const URL_SUBS_RESULTS = (mSite + '/GetSubsessionResults')
export const URL_CURRENT_SEASONS = (mSite + '/GetSeasons')
export const URL_SEASON_STANDINGS = (mStats + '/GetSeasonStandings')
export const URL_SERIES_RACERESULTS = (mStats + '/GetSeriesRaceResults')

// RECENT HISTORICAL
export const URL_LASTRACE_STATS = (mStats + '/GetLastRacesStats')
export const URL_LAST_SERIES = (mStats + '/GetLastSeries')
export const URL_RESULTS = (mStats + '/GetResults')
export const URL_WORLD_RECORDS = (mStats + '/GetWorldRecords')

// UPCOMING SESSIONS
export const URL_SESSION_TIMES = (mSite + '/GetSessionTimes')
export const URL_NEXT_EVENT = (mSite + '/GetNextEvent')
export const URL_TOTALREGISTERED = (mSite + '/GetTotalSessionJoinedCountsBySeason')
export const URL_RACEGUIDE = (mSite + '/GetRaceGuide')
export const URL_ACTIVEOP_COUNT = (mSite + '/GetActiveOpenPracticeCount')
...
export const URL_STATS_CHART = (mStats + '/GetChartData')
export const URL_CAREER_STATS = (mStats + '/GetCareerStats')
export const URL_YEARLY_STATS = (mStats + '/GetYearlyStats')
export const URL_PERSONAL_BESTS = (mStats + '/GetPersonalBests')

// RACE SPECIFIC RESULTS
export const URL_LAPS_SINGLE = (mSite + '/GetLaps')
export const URL_LAPS_ALL = (mSite + '/GetLapChart')

// UTILITY ?
export const URL_MEM_SUBSESSID = (mSite + '/GetSubsessionForMember')
export const URL_CARS_DRIVEN = (mStats + '/GetCarsDriven')
export const URL_PRIVATE_RESULTS = (mStats + '/GetPrivateSessionResults')
export const URL_CAR_CLASS = (mSite + '/GetCarClassById')
export const URL_TICKER_SESSIONS = (mSite + '/GetTickerSessions')
export const URL_SEASON_FOR_SESSION = (mSite + '/GetSeasonForSession')
export const URL_ALL_SUBSESSIONS = (mSite + '/GetAllSubsessions')
...
export const URL_LEAGUE_SEASONS = (mSite + '/GetLeagueSeasons')
...
export const URL_LEAGUE_SEASON_STANDINGS = (mSite + '/GetLeagueSeasonStandings')

// Required param leagueid
export const URL_LEAGUE = (mSite + '/GetLeague')
...
export const URL_DRIVER_STATUS = (mSite + '/GetDriverStatus')
export const URL_MEM_DIVISION = (mSite + '/GetMembersDivision')
